...
CATEGORY_PROFILES: dict[NormalizedCategory, CategoryProfile] = {
    ...
    "small_home_appliance": CategoryProfile(
        ...
        common_conversion_blockers=[
            ...
            "missing cleaning or maintenance detail",
            "weak quality proof",
        ],
        common_return_risks=[
...
FIELD_HINTS = {
    ...
    "capacity": ["capacity", "liter", "litre", "ml", "cup", "tank"],
    "power usage": ["power", "watt", "energy"],
    "cleaning/maintenance details": ["clean", "cleaning", "maintenance", "descale"],
    "safety information": ["safety", "overheat", "automatic shutoff", "safe"],
